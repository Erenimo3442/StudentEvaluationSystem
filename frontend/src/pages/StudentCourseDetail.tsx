...
const StudentCourseDetail = () => {
      ...
      tooltip: {
        y: {
          formatter: (
            ...
            const lo = loScores[dataPointIndex]?.learning_outcome
            return lo ? `${val}% - ${lo.description}` : `${val}%`
          },
        },
      },
    },
  ...
  const sidebarItems = [
    { id: 'assessments' as TabType, label: 'Assessments', icon: ClipboardDocumentListIcon },
    { id: 'outcomes' as TabType, label: 'Outcomes', icon: AcademicCapIcon },
    { id: 'analytics' as TabType, label: 'Analytics', icon: ChartPieIcon },
  ]
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-4 text-left text-sm font-medium transition-colors border-b border-gray-100 last:border-b-0 ${
                  activeTab === item.id
                  ...
                  <Card className="bg-primary-50 border-primary-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Based on all assessments</p>
                      </div>
